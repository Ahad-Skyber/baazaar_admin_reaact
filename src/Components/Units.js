...
<br></br>
     ...
     {/* begin::Products */}
		<div className="card card-flush">								
		  ...
		  {/* <ReactToExcel table="unitList" filename="unit_List" sheet="sheet1" buttonText="Export to Excel" className="btnCancel"/> */}
          <button className="btn btn-sm btn-light"  onClick={addNew}>Add New</button> 
									...
									<div className="card-body pt-0">
								     ...
								     <table className="table align-middle table-row-dashed fs-6 gy-5" id="unit_list">					
											<thead>
